...
class Tasks_endDate extends StatefulWidget {
  const Tasks_endDate({super.key});

  @override
  State<Tasks_endDate> createState() => _SlidebleListState1();
}

class _SlidebleListState1 extends State<Tasks_endDate> with SingleTickerProviderStateMixin {
  ...
  Future<void> saveTaskToDB() async {
    ...
    try {
      ...
      if (dropdownvalu == "OneTime") {
        ...
        while (
        //remindDateUpTo != null &&
        (loopDate.isBefore(loopEndDate) || loopDate.isAtSameMomentAs(loopEndDate))) {
