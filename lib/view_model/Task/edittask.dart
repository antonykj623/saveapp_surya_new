...
import 'package:new_project_2025/app/Modules/accounts/editaccountdetails.dart';
...
class EditTasks extends StatefulWidget {
  ...
  const EditTasks({super.key, required this.task1});

  @override
  State<EditTasks> createState() => _SlidebleListState1();
}

class _SlidebleListState1 extends State<EditTasks> {

  final dbHelper = DatabaseHelper();

  late TextEditingController task;
  late TextEditingController startdateCtl;
  late TextEditingController enddateCtl1;
  late TextEditingController _timeController;
  late TextEditingController dropdownController;
  //late TextEditingController dropdownController1 = TextEditingController();
  TextEditingController dropdownController1 = TextEditingController();
  late TextEditingController reminddateCtl1;
  late String dropdownvalu;
    String dropdownval1 = "initial";
 late String status1 = "";
  ...
  void _loadData() async {
    ...
    setState(() {
     ...
     // status1 = stat.toString();

      print("status from jsondecod is  $stat");
    });
  }
  @override
  void initState() {
    ...
    task = TextEditingController(text: widget.task1.task);
    startdateCtl = TextEditingController(text: widget.task1.startDate);
    enddateCtl1 = TextEditingController(text: widget.task1.endDate);
    _timeController = TextEditingController(text: widget.task1.time);
    dropdownController = TextEditingController(text: widget.task1.selectedItem);
    reminddateCtl1 = TextEditingController(text: widget.task1.remindUpto);
    dropdownvalu = widget.task1.selectedItem;

    dropdownController1.text = dropdownval1;

   // status1 = widget.task1.status;
    setState(() {
      // dropdownController1.text = dropdownval1;
    });
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      AnimatedTextField(
                        controller: dropdownController1,
                        ...
                        onTap: () async {
                          ...
                          if (selected != null) {
                            setState(() {
                              ...
                              dropdownController1.text = selected;
                              print("dropdown value is ${dropdownController1.text}");
                              dropdownval1 = selected;
                              print("dropdownstatus value is ${dropdownval1}");
                              // dropdownController1.text = selected;
                           //   dropdownvalu1 = selected;
                            });
                          }
                        },
                      ),
                        ...
                        AnimatedTextField(
                          ...
                          onTap: () async {
                            ...
                            if (date != null) {
                              ...
                              DateFormat('dd/MM/yyyy').format(date);
                              setState(() {
                                reminddateCtl1.text = formattedDate;
                              });
                            }
                          },
                        ),
                      ...
                      Container(
                        child: ElevatedButton(
                          onPressed: () async {
                                ...
                                final keyid = widget.task1.keyid;

                                final taskData = {
                                  "task": task.text,
                                  "statrdatectrl": startdateCtl.text,
                                  "enddatectrl": enddateCtl1.text,
                                  "timectrl": _timeController.text,
                                  "reminddateupto": reminddateCtl1.text,
                                  "selectedItem": dropdownvalu,
                                  "status": dropdownController1.text
                                };
...
// Include the AnimatedBorderWidget, CustomAnimatedBorder, AnimatedBorderPainter, and AnimatedTextField classes as they were in the original code
// [Assuming these classes remain unchanged as they are not the source of the issue]
...
// import 'package:new_project_2025/view/home/widget/save_DB/Budegt_database_helper/Save_DB.dart';
// class EditTasks extends StatefulWidget {
//   const EditTasks({super.key, required, required TaskModel task1 });
//
//   @override
//   State<EditTasks> createState() => _SlidebleListState1();
// }
...
//                         ),
//
//                       /// Status Dropdown (only if Update)
//                       // if (_buttonLabel == 'Update')
...
//                       //     },
//                       //   ),
//                       // if (_buttonLabel == 'Update') SizedBox(height: 20),
//
//                       /// Frequency Dropdown
//                       // DropdownButtonFormField<String>(
//                       //   value: dropdownvalu,
...
//                             final reminddateupto = reminddateCtl1.text ?? "no data";
//                             print('task is ...$task1');
//                             print('statrdatectrl is ...statrdatectrl1');
//                             print('enddatectrl1 is ...$enddatectrl');
//                             print('timectrl1 is ...$timectrl1');
//                             print('reminddateupto1 is ...$reminddateupto');
//                             print('timectrl1 is ...$timectrl1');
//
//                             Map<String, dynamic> taskData = {
//                               "task":task1,
//                               "statrdatectrl":statrdatectrl1,
