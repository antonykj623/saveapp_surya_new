...
import 'package:new_project_2025/view_model/My%20Diary/addDiary.dart';
  ...
  void showmyDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: Colors.grey[200], // 👈 grey dialog background
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12), // optional nice rounded corners
          ),
          content: Container(
            width: 300,
            height: 300,
